...
export default function iDrunkPage() {
  return (
    <>
      <NavBar />
      <br />
        ...
        <Grid.Row>
          <Segment raised className="third-animation">
            <p className="story" style={{ width: 400 }}>
              ...
              ones from people all around the world! Post comments under some of
              your favorite (or least favorite) drinks, and keep a private
