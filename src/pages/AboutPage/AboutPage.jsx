  ...
  return (
    <>
      ...
      <p>
        ...
        Java, but didn’t pursue it as a career until much later in life. I
        recently helped construct a VBA macro for my former company which was
        deployed to over 300+ independent contractors. After a short time at the
        company it was obvious that many of our tasks were repetitive and needed
        automation. I took it upon myself to write this macro in an effort to
        increase efficiency, and we ended up implementing it company-wide.
        Throughout writing it, I taught myself object-oriented programming
        concepts, and reinvigorated my love affair with programming. I unlocked
        all the same feelings I had in high school after I made “Perfect Pump”.
